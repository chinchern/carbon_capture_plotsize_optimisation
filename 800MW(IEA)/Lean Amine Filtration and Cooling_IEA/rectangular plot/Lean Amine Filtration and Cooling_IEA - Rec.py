...
#Iteration 1
# units = ['lean_amine_cooler_T1_1','lean_amine_cooler_T1_2','lean_amine_cooler_T1_3','lean_amine_cooler_T1_4',
#           'CW_pump_T1_1','CW_pump_T1_2','CW_pump_T1_3','CW_cooler_T1','CW_expansion_vessel_T1']
           
#Iteration 2
# units = ['lean_amine_cooler_T1_1','lean_amine_cooler_T1_2','lean_amine_cooler_T1_3','lean_amine_cooler_T1_4',
#           'CW_pump_T1_1','CW_pump_T1_2','CW_pump_T1_3','CW_cooler_T1',
#           'CW_expansion_vessel_T1','upstream_filter_T1','carbon_filter_T1','downstream_filter_T1']
...
#           ,'lean_amine_cooler_T2_1','lean_amine_cooler_T2_2','lean_amine_cooler_T2_3','lean_amine_cooler_T2_4'
#             ,'CW_pump_T2_1','CW_pump_T2_2','CW_pump_T2_3'
#             ,'CW_cooler_T2','CW_expansion_vessel_T2']
...
units = ['lean_amine_cooler_T1_1','lean_amine_cooler_T1_2','lean_amine_cooler_T1_3','lean_amine_cooler_T1_4',
          ...
          'lean_amine_cooler_T2_1','lean_amine_cooler_T2_2','lean_amine_cooler_T2_3','lean_amine_cooler_T2_4',
          'CW_pump_T2_1','CW_pump_T2_2','CW_pump_T2_3','CW_cooler_T2',
          'CW_expansion_vessel_T2','upstream_filter_T2','carbon_filter_T2','downstream_filter_T2']

Nunits = len(units)

if SwitchSafetyDistances == 1:
    # type of equipment      
    column =['CW_expansion_vessel_T1'
             ,'CW_expansion_vessel_T2']
    heat_exchanger =['lean_amine_cooler_T1_1','lean_amine_cooler_T1_2','lean_amine_cooler_T1_3','lean_amine_cooler_T1_4','CW_cooler_T1'
                     ,'lean_amine_cooler_T2_1','lean_amine_cooler_T2_2','lean_amine_cooler_T2_3','lean_amine_cooler_T2_4','CW_cooler_T2']
    pump=['CW_pump_T1_1','CW_pump_T1_2','CW_pump_T1_3'
          ,'CW_pump_T2_1','CW_pump_T2_2','CW_pump_T2_3']
...
alpha['lean_amine_cooler_T1_1'] =4
alpha['lean_amine_cooler_T1_2'] =4
alpha['lean_amine_cooler_T1_3'] =4
alpha['lean_amine_cooler_T1_4'] =4
alpha['CW_pump_T1_1'] =1.29
alpha['CW_pump_T1_2'] =1.29
alpha['CW_pump_T1_3'] = 1.29
alpha['CW_cooler_T1'] =22.4
alpha['CW_expansion_vessel_T1'] =2.6

beta['lean_amine_cooler_T1_1'] = 1.5
beta['lean_amine_cooler_T1_2'] =1.5
beta['lean_amine_cooler_T1_3'] =1.5
beta['lean_amine_cooler_T1_4'] =1.5
beta['CW_pump_T1_1'] =1.285
beta['CW_pump_T1_2'] =1.285
beta['CW_pump_T1_3'] = 1.285
beta['CW_cooler_T1'] =2.75
beta['CW_expansion_vessel_T1'] =1.8

alpha['upstream_filter_T1'] =2.5
alpha['carbon_filter_T1'] =3.9
alpha['downstream_filter_T1'] =0.9

beta['upstream_filter_T1'] =0.6
beta['carbon_filter_T1'] =3.5
beta['downstream_filter_T1'] =2.9

alpha['lean_amine_cooler_T2_1'] =4
alpha['lean_amine_cooler_T2_2'] =4
alpha['lean_amine_cooler_T2_3'] =4
alpha['lean_amine_cooler_T2_4'] =4
alpha['CW_pump_T2_1'] =1.29
alpha['CW_pump_T2_2'] =1.29
alpha['CW_pump_T2_3'] = 1.29
alpha['CW_cooler_T2'] =22.4
alpha['CW_expansion_vessel_T2'] =2.6

beta['lean_amine_cooler_T2_1'] = 1.5
beta['lean_amine_cooler_T2_2'] =1.5
beta['lean_amine_cooler_T2_3'] =1.5
beta['lean_amine_cooler_T2_4'] =1.5
beta['CW_pump_T2_1'] =1.285
beta['CW_pump_T2_2'] =1.285
beta['CW_pump_T2_3'] = 1.285
beta['CW_cooler_T2'] =2.75
beta['CW_expansion_vessel_T2'] =1.8

alpha['upstream_filter_T2'] =2.5
alpha['carbon_filter_T2'] =3.9
alpha['downstream_filter_T2'] =0.9

beta['upstream_filter_T2'] =0.6
beta['carbon_filter_T2'] =3.5
beta['downstream_filter_T2'] =2.9
...
if SwitchPumpingCost == 1:   
    ...
    mass_flowrate[0][1] = 59 
    mass_flowrate[1][2] = 59
    mass_flowrate[2][3] = 59
    mass_flowrate[3][4] = 59
    mass_flowrate[4][5] = 59 
    mass_flowrate[5][6] = 59
    mass_flowrate[6][7] = 59
    mass_flowrate[7][8] = 59
    
    mass_flowrate[3][9] = 53
    mass_flowrate[9][10] = 53
    mass_flowrate[10][11] = 53
    
    mass_flowrate[12][13] = 59 
    mass_flowrate[13][14] = 59
    mass_flowrate[14][15] = 59
    mass_flowrate[15][16] = 59
    mass_flowrate[16][17] = 59 
    mass_flowrate[17][18] = 59
    mass_flowrate[18][19] = 59
    mass_flowrate[19][20] = 59
    
    mass_flowrate[15][21] = 53
    mass_flowrate[21][22] = 53
    mass_flowrate[22][23] = 53
    ...
    fluid_velocity[3][9] = 3
    fluid_velocity[9][10] = 3
    fluid_velocity[10][11] = 3
    
    fluid_velocity[12][13] = 3 
    fluid_velocity[13][14] = 3
    fluid_velocity[14][15] = 3
    fluid_velocity[15][16] = 3
    fluid_velocity[16][17] = 3 
    fluid_velocity[17][18] = 3
    fluid_velocity[18][19] = 3
    fluid_velocity[19][20] = 3
    
    fluid_velocity[15][21] = 3
    fluid_velocity[21][22] = 3
    fluid_velocity[22][23] = 3
    ...
    fluid_density[3][9] = 993
    fluid_density[9][10] = 993
    fluid_density[10][11] = 993
    
    fluid_density[12][13] = 997 
    fluid_density[13][14] = 997
    fluid_density[14][15] = 997
    fluid_density[15][16] = 997
    fluid_density[16][17] = 997 
    fluid_density[17][18] = 997
    fluid_density[18][19] = 997
    fluid_density[19][20] = 997
    
    fluid_density[15][21] = 993
    fluid_density[21][22] = 993
    fluid_density[22][23] = 993
    ...
    friction_factor[0][1] = 0.0162 
    friction_factor[1][2] = 0.0162
    friction_factor[2][3] = 0.0162
    friction_factor[3][4] = 0.0162
    friction_factor[4][5] = 0.0162 
    friction_factor[5][6] = 0.0162
    friction_factor[6][7] = 0.0162
    friction_factor[7][8] = 0.0162
    
    friction_factor[3][9] = 0.0162
    friction_factor[9][10] =0.0162
    friction_factor[10][11] = 0.0162
    
    friction_factor[12][13] = 0.0162 
    friction_factor[13][14] = 0.0162
    friction_factor[14][15] = 0.0162
    friction_factor[15][16] = 0.0162
    friction_factor[16][17] = 0.0162 
    friction_factor[17][18] = 0.0162
    friction_factor[18][19] = 0.0162
    friction_factor[19][20] = 0.0162
    
    friction_factor[15][21] = 0.0162
    friction_factor[21][22] = 0.0162
    friction_factor[22][23] = 0.0162
...
fix_variable(x['lean_amine_cooler_T1_1'],6.75)
fix_variable(x['lean_amine_cooler_T1_2'],2)
fix_variable(x['lean_amine_cooler_T1_3'],2)
fix_variable(x['lean_amine_cooler_T1_4'],2)
fix_variable(x['CW_pump_T1_1'],1.605)
fix_variable(x['CW_pump_T1_2'],1.605)  
fix_variable(x['CW_pump_T1_3'],1.605)
fix_variable(x['CW_cooler_T1'],6.625)
fix_variable(x['CW_expansion_vessel_T1'],1.35)

fix_variable(y['lean_amine_cooler_T1_1'],32)
fix_variable(y['lean_amine_cooler_T1_2'],32.15)
fix_variable(y['lean_amine_cooler_T1_3'],28.65)
fix_variable(y['lean_amine_cooler_T1_4'],25.15)
fix_variable(y['CW_pump_T1_1'],20.7575)
fix_variable(y['CW_pump_T1_2'],17.4725)  
fix_variable(y['CW_pump_T1_3'],14.1875)
fix_variable(y['CW_cooler_T1'],11.2)
fix_variable(y['CW_expansion_vessel_T1'],9.244999996)


fix_variable(x['upstream_filter_T1'],2)
fix_variable(x['carbon_filter_T1'],5.75)
fix_variable(x['downstream_filter_T1'],5.75)

fix_variable(y['upstream_filter_T1'],26.2)
fix_variable(y['carbon_filter_T1'],	26.2)
fix_variable(y['downstream_filter_T1'],28.6)

fix_variable(x['lean_amine_cooler_T2_1'],2)
fix_variable(x['lean_amine_cooler_T2_2'],2)
fix_variable(x['lean_amine_cooler_T2_3'],2)
fix_variable(x['lean_amine_cooler_T2_4'],6.75)
fix_variable(x['CW_pump_T2_1'],6.75)
fix_variable(x['CW_pump_T2_2'],6.75)  
fix_variable(x['CW_pump_T2_3'],6.75)
fix_variable(x['CW_cooler_T2'],1.73)
fix_variable(x['CW_expansion_vessel_T2'],7.005)

fix_variable(y['lean_amine_cooler_T2_1'],35.65)
fix_variable(y['lean_amine_cooler_T2_2'],39.15)
fix_variable(y['lean_amine_cooler_T2_3'],42.65)
fix_variable(y['lean_amine_cooler_T2_4'],42)
fix_variable(y['CW_pump_T2_1'],47.6425)
fix_variable(y['CW_pump_T2_2'],50.9275)  
fix_variable(y['CW_pump_T2_3'],54.2125)
fix_variable(y['CW_cooler_T2'],56.8)
fix_variable(y['CW_expansion_vessel_T2'],59.155)
