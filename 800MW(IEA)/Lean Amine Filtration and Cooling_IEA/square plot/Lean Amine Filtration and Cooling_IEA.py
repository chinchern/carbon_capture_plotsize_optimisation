...
if SwitchPumpingCost == 1:   
    ...
    mass_flowrate[9][10] = 59 
    mass_flowrate[10][11] = 59
    mass_flowrate[11][12] = 59
...
fix_variable(x['lean_amine_cooler_T1_1'],13.237500000000098)
fix_variable(x['lean_amine_cooler_T1_2'],9.737500000000098)
fix_variable(x['lean_amine_cooler_T1_3'],6.237500000000098)
fix_variable(x['lean_amine_cooler_T1_4'],6.237500000000098)
fix_variable(x['CW_pump_T1_1'],6.237500000000098)
fix_variable(x['CW_pump_T1_2'],9.522500000000067)  
fix_variable(x['CW_pump_T1_3'],12.807500000000035)
fix_variable(x['CW_cooler_T1'],17.825000000000024)
fix_variable(x['CW_expansion_vessel_T1'],23.1)

fix_variable(y['lean_amine_cooler_T1_1'],2.0550000000000237)
fix_variable(y['lean_amine_cooler_T1_2'],2.0550000000000237)
fix_variable(y['lean_amine_cooler_T1_3'],2.0550000000000237)
fix_variable(y['lean_amine_cooler_T1_4'],6.8050000000000175)
fix_variable(y['CW_pump_T1_1'],11.2)
fix_variable(y['CW_pump_T1_2'],11.2)  
fix_variable(y['CW_pump_T1_3'],11.2)
fix_variable(y['CW_cooler_T1'],11.2)
fix_variable(y['CW_expansion_vessel_T1'],11.2)



fix_variable(x['lean_amine_cooler_T2_2'],7.90000000000005)
fix_variable(x['lean_amine_cooler_T2_3'],4.40000000000005)
fix_variable(x['lean_amine_cooler_T2_4'],0.9000000000000501)
fix_variable(x['CW_pump_T2_1'],5.98000000000021)
fix_variable(x['CW_pump_T2_2'],9.265000000000178)  
fix_variable(x['CW_pump_T2_3'],12.550000000000033)
fix_variable(x['CW_cooler_T2'],12.550000000000033)
fix_variable(x['CW_expansion_vessel_T2'],12.550000000000027)

fix_variable(y['lean_amine_cooler_T2_1'],20.490000000000045)
fix_variable(y['lean_amine_cooler_T2_2'],20.490000000000045)
fix_variable(y['lean_amine_cooler_T2_3'],20.490000000000045)
fix_variable(y['lean_amine_cooler_T2_4'],14.490000000000084)
fix_variable(y['CW_pump_T2_1'],14.490000000000084)
fix_variable(y['CW_pump_T2_2'],14.490000000000084)  
fix_variable(y['CW_pump_T2_3'],14.490000000000084)
fix_variable(y['CW_cooler_T2'],25.86500000000009)
fix_variable(y['CW_expansion_vessel_T2'],20.19000000000009)
...
# Set bounds of axis
plt.axis('square')
scalebar = AnchoredSizeBar(ax.transData,5,sep=5,label="bar scale: 5 m",loc ='lower left',bbox_to_anchor=(1.1,-.1),bbox_transform=ax.transAxes,frameon=False,size_vertical=0.05)
...
for i in range(len(numbers)):
    ...
    ax.add_patch(rect)
    leg = ax.legend(handlelength=0, handletextpad=0, fancybox=True, bbox_to_anchor=(1.04,1), loc="upper left", fontsize = 7)
