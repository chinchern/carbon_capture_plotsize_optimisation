...
fix_variable(x['absorber_T1'],12.5)
fix_variable(x['wash_water_pump_T1_1'],12.5)
fix_variable(x['wash_water_pump_T1_2'],8.772)
fix_variable(x['wash_water_cooler_T1'],8.772)
fix_variable(x['rich_pump_T1_1'],17.8875)
fix_variable(x['rich_pump_T1_2'],23.0655)  

fix_variable(y['absorber_T1'],18.078)
fix_variable(y['wash_water_pump_T1_1'],6.464)
fix_variable(y['wash_water_pump_T1_2'],6.464)
fix_variable(y['wash_water_cooler_T1'],1.3)
fix_variable(y['rich_pump_T1_1'],6.464)
fix_variable(y['rich_pump_T1_2'],4.8045)  

# fix_variable(x['absorber_T1'],alpha['absorber_T1']/2)
# fix_variable(y['absorber_T1'],beta['absorber_T1']/2)

# fix_variable(y['absorber_T2'],alpha['absorber_T2']/2)
# fix_variable(y['wash_water_cooler_T2'],24.528)
