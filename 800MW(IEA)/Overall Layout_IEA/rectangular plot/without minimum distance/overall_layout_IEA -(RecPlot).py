...
fix_variable(x['direct_contact_cooler'],65.99999999999999)
fix_variable(x['absorber'],65.99999999999999)
fix_variable(x['lean_amine_cooler'],32.0)
fix_variable(x['cross_heat_exchanger'],22.0)
fix_variable(x['stripper'],115.99999999999999)
fix_variable(x['storage_tank'],8.0)
fix_variable(x['reclaimer'],11.0)

fix_variable(y['direct_contact_cooler'],21.0)
fix_variable(y['absorber'],55.000000000000455)
fix_variable(y['lean_amine_cooler'],35.99999999999999)
fix_variable(y['cross_heat_exchanger'],36.76299924317014)
fix_variable(y['stripper'],36.76299924317014)
fix_variable(y['storage_tank'],22.000000000000906)
fix_variable(y['reclaimer'],50.7629992431706)

fix_variable(x['compressor_house'],90.99999999999953)
fix_variable(x['compressor_KOdrum'],90.99999999999953)
fix_variable(x['compressor_interstage_cooler'],90.99999999999953)
fix_variable(x['TEG_dehydration'],90.99999999999953)

fix_variable(y['compressor_house'],80.0)
fix_variable(y['compressor_KOdrum'],74.0)
fix_variable(y['compressor_interstage_cooler'],85.0)
fix_variable(y['TEG_dehydration'],70.0)
...
# Set bounds of axis
plt.axis('square')
scalebar = AnchoredSizeBar(ax.transData,20,sep=10,label="bar scale: 20 m",loc ='lower left',bbox_to_anchor=(0.75,0.8),bbox_transform=ax.transAxes,frameon=False,size_vertical=0.05)
ax.add_artist(scalebar)

ax.set_xlim(0,max(xpos)+20)
ax.set_ylim(0,max(ypos)+20)

# Place unit number at each scatter point
numbers = list(range(1,len(xpos)+1))
for i,txt in enumerate(numbers):
       ax.annotate(txt, (xpos[i]-3,ypos[i]-.5))
