...
alpha['direct_contact_cooler'] = 42
alpha['absorber'] =26
alpha['lean_amine_cooler'] = 8
alpha['cross_heat_exchanger'] =20
alpha['stripper'] =62
alpha['storage_tank'] = 16
alpha['reclaimer'] = 22

beta['direct_contact_cooler'] = 60
beta['absorber'] =54
beta['lean_amine_cooler'] = 68
beta['cross_heat_exchanger'] =12
beta['stripper'] =40
beta['storage_tank'] = 44
beta['reclaimer'] = 8

alpha['compressor_house'] = 37.5
alpha['compressor_KOdrum'] =86
alpha['compressor_interstage_cooler'] = 134
alpha['TEG_dehydration'] = 4

beta['compressor_house'] = 8
beta['compressor_KOdrum'] =4
beta['compressor_interstage_cooler'] = 2
beta['TEG_dehydration'] = 22

alpha['cooling_tower'] = 68
beta['cooling_tower'] = 34
...
fix_variable(x['direct_contact_cooler'],37.99999999999998)
fix_variable(x['absorber'],37.99999999999998)
fix_variable(x['lean_amine_cooler'],34.0)
fix_variable(x['cross_heat_exchanger'],36.00000000000003)
fix_variable(x['stripper'],36.00000000000003)
fix_variable(x['storage_tank'],8.0)
fix_variable(x['reclaimer'],11.0)

fix_variable(y['direct_contact_cooler'],21.0)
fix_variable(y['absorber'],70.00000000000045)
fix_variable(y['lean_amine_cooler'],102.00000000000045)
fix_variable(y['cross_heat_exchanger'],132.0000000000009)
fix_variable(y['stripper'],178.00000000000085)
fix_variable(y['storage_tank'],296.00000000000136)
fix_variable(y['reclaimer'],132.0000000000009)


fix_variable(x['compressor_house'],100.00000000000024)
fix_variable(x['compressor_KOdrum'],85.00000000000023)
fix_variable(x['compressor_interstage_cooler'],114.00000000000024)
fix_variable(x['TEG_dehydration'],66.00000000000023)

fix_variable(y['compressor_house'],132.00000000000023)
fix_variable(y['compressor_KOdrum'],132.00000000000023)
fix_variable(y['compressor_interstage_cooler'],132.00000000000023)
fix_variable(y['TEG_dehydration'],132.00000000000023)

fix_variable(x['cooling_tower'],109.00000000000023)
fix_variable(x['coolingwater_pumphouse'],109.00000000000023)

fix_variable(y['cooling_tower'],283.9999999999999)
fix_variable(y['coolingwater_pumphouse'],214.9999999999999)
...
# Set bounds of axis
plt.axis('square')
scalebar = AnchoredSizeBar(ax.transData,50,sep=10,label="bar scale: 50 m",loc ='lower left',bbox_to_anchor=(1.1,0),bbox_transform=ax.transAxes,frameon=False,size_vertical=0.05)
