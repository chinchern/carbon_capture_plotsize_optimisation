...
#       variable.fixValue()
# fix_variable(x['ct_1'],alpha['ct_1']/2)
# fix_variable(y['ct_1'],beta['ct_1']/2)


# fix_variable(y['ct_2'],beta['ct_2']/2)
# fix_variable(y['ct_1'],beta['ct_3']/2)
...
#Rectangular
# fix_variable(x['ct_1'],28)
# fix_variable(x['ct_2'],	20)
# fix_variable(x['ct_3'],	12)
# fix_variable(x['ct_4'],	4)
