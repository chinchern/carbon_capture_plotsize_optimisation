...
# assign values where flowsheet connection
 # no connection cost between cooling_tower. 
 # This connections are to ensure they are close to each other.Not included in objective function.
# C[0][1] = 1
# C[1][2] = 1  
# C[2][3] = 1  
# C[3][4] = 1  
...
if SwitchSafetyDistances == 1:
    ...
    for i in cooling_tower:
        for j in cooling_tower:
            D_min[i][j] =0            
else:
    for i in units:
        for j in units:
...
def fix_variable(variable, value):
      ...
      variable.fixValue()
fix_variable(x['ct_5'],alpha['ct_5']/2)
# fix_variable(y['ct_1'],beta['ct_1']/2)


#Square Plot (tidy up)
# fix_variable(x['ct_1'],4)
# fix_variable(x['ct_2'],	12)
# fix_variable(x['ct_3'],	20)
# fix_variable(x['ct_4'],	20)
# fix_variable(x['ct_5'],	12)
# fix_variable(x['ct_6'],	4)


# fix_variable(y['ct_1'],	4)
# fix_variable(y['ct_2'],	4)
# fix_variable(y['ct_3'],	4)
# fix_variable(y['ct_4'],	12)
# fix_variable(y['ct_5'],	12)
# fix_variable(y['ct_6'],	12)

#Rectangular
fix_variable(x['ct_1'],42.5)
fix_variable(x['ct_2'],	59.5)
fix_variable(x['ct_3'],	25.5)
fix_variable(x['ct_4'],	8.5)
# fix_variable(x['ct_5'],	45.25)
# fix_variable(x['ct_6'],	45.25)
# fix_variable(x['ct_7'],	45.25)
# fix_variable(x['ct_8'], 27.15)


fix_variable(y['ct_1'],	8.5)
fix_variable(y['ct_2'],	8.5)
fix_variable(y['ct_3'],	8.5)
fix_variable(y['ct_4'],	8.5)

# fix_variable(y['ct_5'],	45.25)
# fix_variable(y['ct_6'],	27.15)
# fix_variable(y['ct_7'],	9.05)
# fix_variable(y['ct_8'], 9.05)
# fix_variable(y['ct_9'],	27.15)
...
# Set bounds of axis
plt.axis('square')
scalebar = AnchoredSizeBar(ax.transData,5,sep=10,label="bar scale: 5 m",loc ='lower left',bbox_to_anchor=(1.1,0),bbox_transform=ax.transAxes,frameon=False,size_vertical=0.05)
...
for i in range(len(numbers)):
    ...
    ax.add_patch(rect)
    leg = ax.legend(handlelength=0, handletextpad=0, fancybox=True, bbox_to_anchor=(1.04,1), loc="upper left", fontsize = 11)
