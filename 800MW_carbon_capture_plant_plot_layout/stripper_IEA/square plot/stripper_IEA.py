...
fix_variable(x['reboiler_T1_3'],1.2)
fix_variable(x['reboiler_T1_4'],5.6)
fix_variable(x['reboiler_condensate_drum_T1'],10.8)  
fix_variable(x['condensate_pump_T1_1'],15.2159)
fix_variable(x['condensate_pump_T1_2'],18.0477)

fix_variable(y['stripper_T1'],4.7)
fix_variable(y['reboiler_T1_1'],5.15)
fix_variable(y['reboiler_T1_2'],5.15)
fix_variable(y['reboiler_T1_3'],16.85)
fix_variable(y['reboiler_T1_4'],16.85)
fix_variable(y['reboiler_condensate_drum_T1'],16.85)  
fix_variable(y['condensate_pump_T1_1'],16.85)
fix_variable(y['condensate_pump_T1_2'],16.85)

fix_variable(x['condenser_T1_1'],23.3136)
fix_variable(x['condenser_T1_2'],29.0136)
fix_variable(x['overhead_received_T1'],35.7386)
fix_variable(x['reflux_pump_T1_1'],35.7386)
fix_variable(x['reflux_pump_T1_2'],35.7386)
fix_variable(x['water_wash_pump_T1'],4)

fix_variable(y['condenser_T1_1'],15.75)
fix_variable(y['condenser_T1_2'],	15.75)
fix_variable(y['overhead_received_T1'],15.75)
fix_variable(y['reflux_pump_T1_1'],22.7059)
fix_variable(y['reflux_pump_T1_2'],25.2177)  
fix_variable(y['water_wash_pump_T1'],25.44)

fix_variable(x['stripper_T2'],	37.8636)
fix_variable(x['reboiler_T2_1'],25.7136)
fix_variable(x['reboiler_T2_2'],25.7136)
fix_variable(x['reboiler_T2_3'],12.2)
fix_variable(x['reboiler_T2_4'],12.2)
fix_variable(x['reboiler_condensate_drum_T2'],12.2)  
fix_variable(x['condensate_pump_T2_1'],12.2)
fix_variable(x['condensate_pump_T2_2'],12.2)

fix_variable(y['stripper_T2'],35.4636)
fix_variable(y['reboiler_T2_1'],35.4636)
fix_variable(y['reboiler_T2_2'],39.8636)
fix_variable(y['reboiler_T2_3'],39.8636)
fix_variable(y['reboiler_T2_4'],35.4636)
fix_variable(y['reboiler_condensate_drum_T2'],30.2636)  
fix_variable(y['condensate_pump_T2_1'],25.8477)
fix_variable(y['condensate_pump_T2_2'],23.0159)
