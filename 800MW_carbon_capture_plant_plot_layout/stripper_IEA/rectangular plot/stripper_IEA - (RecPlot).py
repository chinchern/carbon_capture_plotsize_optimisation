...
#Iteration 1
# units = ['stripper_T1','reboiler_T1_1','reboiler_T1_2','reboiler_T1_3','reboiler_T1_4','reboiler_condensate_drum_T1','condensate_pump_T1_1','condensate_pump_T1_2']
                  
#Iteration 2
# units = ['stripper_T1','reboiler_T1_1','reboiler_T1_2','reboiler_T1_3','reboiler_T1_4','reboiler_condensate_drum_T1','condensate_pump_T1_1','condensate_pump_T1_2'
#           , 'condenser_T1_1','condenser_T1_2','overhead_received_T1','reflux_pump_T1_1','reflux_pump_T1_2','water_wash_pump_T1']
        
#Iteration 3
# units = ['stripper_T1','reboiler_T1_1','reboiler_T1_2','reboiler_T1_3','reboiler_T1_4','reboiler_condensate_drum_T1','condensate_pump_T1_1','condensate_pump_T1_2'
#           , 'condenser_T1_1','condenser_T1_2','overhead_received_T1','reflux_pump_T1_1','reflux_pump_T1_2','water_wash_pump_T1'
#           ,'stripper_T2','reboiler_T2_1','reboiler_T2_2','reboiler_T2_3','reboiler_T2_4','reboiler_condensate_drum_T2','condensate_pump_T2_1','condensate_pump_T2_2']
                    
#Iteration 4
units = ['stripper_T1','reboiler_T1_1','reboiler_T1_2','reboiler_T1_3','reboiler_T1_4','reboiler_condensate_drum_T1','condensate_pump_T1_1','condensate_pump_T1_2'
          , 'condenser_T1_1','condenser_T1_2','overhead_received_T1','reflux_pump_T1_1','reflux_pump_T1_2','water_wash_pump_T1'
          ,'stripper_T2','reboiler_T2_1','reboiler_T2_2','reboiler_T2_3','reboiler_T2_4','reboiler_condensate_drum_T2','condensate_pump_T2_1','condensate_pump_T2_2'
          , 'condenser_T2_1','condenser_T2_2','overhead_received_T2','reflux_pump_T2_1','reflux_pump_T2_2','water_wash_pump_T2']

Nunits = len(units)

if SwitchSafetyDistances == 1:
    # type of equipment      
    column =['stripper_T1','reboiler_condensate_drum_T1','overhead_received_T1'
             ,'stripper_T2','reboiler_condensate_drum_T2','overhead_received_T2']
    heat_exchanger =['reboiler_T1_1','reboiler_T1_2','reboiler_T1_3','reboiler_T1_4','condenser_T1_1','condenser_T1_2'
                     ,'reboiler_T2_1','reboiler_T2_2','reboiler_T2_3','reboiler_T2_4','condenser_T2_1','condenser_T2_2']
    pump=['condensate_pump_T1_1','condensate_pump_T1_2','reflux_pump_T1_1','reflux_pump_T1_2','water_wash_pump_T1'
          ,'condensate_pump_T2_1','condensate_pump_T2_2','reflux_pump_T2_1','reflux_pump_T2_2','water_wash_pump_T2']
...
alpha['stripper_T1'] =8
alpha['reboiler_T1_1'] =10.3
alpha['reboiler_T1_2'] =10.3
alpha['reboiler_T1_3'] =10.3
alpha['reboiler_T1_4'] =10.3
alpha['reboiler_condensate_drum_T1'] =5.5
alpha['condensate_pump_T1_1'] = 2.33
alpha['condensate_pump_T1_2'] =2.33

beta['stripper_T1'] =8
beta['reboiler_T1_1'] =2.4
beta['reboiler_T1_2'] =2.4
beta['reboiler_T1_3'] =2.4
beta['reboiler_T1_4'] =2.4
beta['reboiler_condensate_drum_T1'] =2
beta['condensate_pump_T1_1'] = 0.8318
beta['condensate_pump_T1_2'] =0.8318


alpha['condenser_T1_1'] =31.5
alpha['condenser_T1_2'] = 31.5
alpha['overhead_received_T1'] =7.4
alpha['reflux_pump_T1_1'] =1.45
alpha['reflux_pump_T1_2'] = 1.45
alpha['water_wash_pump_T1'] =2.49

beta['condenser_T1_1'] =3.7
beta['condenser_T1_2'] = 3.7
beta['overhead_received_T1'] =3.75
beta['reflux_pump_T1_1'] =0.5118
beta['reflux_pump_T1_2'] = 0.5118
beta['water_wash_pump_T1'] =0.88

alpha['stripper_T2'] =8
alpha['reboiler_T2_1'] =10.3
alpha['reboiler_T2_2'] =10.3
alpha['reboiler_T2_3'] =10.3
alpha['reboiler_T2_4'] =10.3
alpha['reboiler_condensate_drum_T2'] =5.5
alpha['condensate_pump_T2_1'] = 2.33
alpha['condensate_pump_T2_2'] =2.33

beta['stripper_T2'] =8
beta['reboiler_T2_1'] =2.4
beta['reboiler_T2_2'] =2.4
beta['reboiler_T2_3'] =2.4
beta['reboiler_T2_4'] =2.4
beta['reboiler_condensate_drum_T2'] =2
beta['condensate_pump_T2_1'] = 0.8318
beta['condensate_pump_T2_2'] =0.8318


alpha['condenser_T2_1'] =31.5
alpha['condenser_T2_2'] = 31.5
alpha['overhead_received_T2'] =7.4
alpha['reflux_pump_T2_1'] =1.45
alpha['reflux_pump_T2_2'] = 1.45
alpha['water_wash_pump_T2'] =2.49

beta['condenser_T2_1'] =3.7
beta['condenser_T2_2'] = 3.7
beta['overhead_received_T2'] =3.75
beta['reflux_pump_T2_1'] =0.5118
beta['reflux_pump_T2_2'] = 0.5118
beta['water_wash_pump_T2'] =0.88
...
if SwitchPumpingCost == 1:   
    ...
    mass_flowrate[0][1] = 49 
    mass_flowrate[1][2] = 49
    mass_flowrate[3][4] = 49
    mass_flowrate[4][5] = 6
    mass_flowrate[5][6] = 6
    mass_flowrate[6][7] = 6
    ...
    mass_flowrate[0][8] = 5
    mass_flowrate[8][9] = 5 
    mass_flowrate[9][10] = 5
    mass_flowrate[10][11] = 5
    mass_flowrate[11][12] = 2
    mass_flowrate[13][0] = 16
    
    mass_flowrate[14][15] = 49 
    mass_flowrate[15][16] = 49
    mass_flowrate[17][18] = 49
    mass_flowrate[18][19] = 6
    mass_flowrate[19][20] = 6
    mass_flowrate[20][21] = 6
    
    mass_flowrate[14][22] = 5
    mass_flowrate[22][23] = 5 
    mass_flowrate[23][24] = 5
    mass_flowrate[24][25] = 5
    mass_flowrate[25][26] = 2
    mass_flowrate[27][14] =16
   
    #Assign values of fluid velocity where flowsheet connection
    fluid_velocity[0][1] = 3 
    fluid_velocity[1][2] = 3
    fluid_velocity[3][4] = 3
    fluid_velocity[4][5] = 30
    fluid_velocity[5][6] = 30
    fluid_velocity[6][7] = 30
       
    fluid_velocity[0][8] = 30
    fluid_velocity[8][9] = 30 
    fluid_velocity[9][10] = 30
    fluid_velocity[10][11] = 3
    fluid_velocity[11][12] = 3
    fluid_velocity[13][0] = 3
    
    fluid_velocity[14][15] = 3 
    fluid_velocity[15][16] = 3
    fluid_velocity[17][18] = 3
    fluid_velocity[18][19] = 30
    fluid_velocity[19][20] = 30
    fluid_velocity[20][21] = 30
    
    fluid_velocity[14][22] = 30
    fluid_velocity[22][23] = 30 
    fluid_velocity[23][24] = 30
    fluid_velocity[24][25] = 3
    fluid_velocity[25][26] = 3
    fluid_velocity[27][14] = 3
   

    #Assign values of density where flowsheet connection
    fluid_density[0][1] = 945 
    fluid_density[1][2] = 945
    fluid_density[3][4] = 945
    fluid_density[4][5] = 0.6
    fluid_density[5][6] = 0.6
    fluid_density[6][7] = 0.6
      
    fluid_density[0][8] = 1.077
    fluid_density[8][9] = 1.077 
    fluid_density[9][10] = 29
    fluid_density[10][11] = 997
    fluid_density[11][12] = 997
    fluid_density[13][0] = 997
    
    fluid_density[14][15] = 945 
    fluid_density[15][16] = 945
    fluid_density[17][18] = 945
    fluid_density[18][19] = 0.6
    fluid_density[19][20] = 0.6
    fluid_density[20][21] = 0.6
    
    fluid_density[14][22] = 1.077
    fluid_density[22][23] = 1.077 
    fluid_density[23][24] = 29
    fluid_density[24][25] = 997
    fluid_density[25][26] =997
    fluid_density[27][14] =997
    ...
    friction_factor[0][1] = 0.0155 
    friction_factor[1][2] = 0.0155
    friction_factor[3][4] = 0.0155
    friction_factor[4][5] = 0.0699
    friction_factor[5][6] = 0.0699
    friction_factor[6][7] = 0.0699
       
    friction_factor[0][8] = 0.0202
    friction_factor[8][9] =  0.0202 
    friction_factor[9][10] = 0.0374
    friction_factor[10][11] =  0.0374
    friction_factor[11][12] = 0.0245
    friction_factor[13][0] = 0.0185
    
    friction_factor[14][15] =  0.0155  
    friction_factor[15][16] =  0.0155 
    friction_factor[17][18] =  0.0155 
    friction_factor[18][19] = 0.0699
    friction_factor[19][20] = 0.0699
    friction_factor[20][21] = 0.0699
    
    friction_factor[14][22] =  0.0202
    friction_factor[22][23] =  0.0202 
    friction_factor[23][24] =  0.0374
    friction_factor[24][25] =  0.0374
    friction_factor[25][26] =  0.0245
    friction_factor[27][14] = 0.0185
...
fix_variable(x['stripper_T1'],4.7)
fix_variable(x['reboiler_T1_1'],5.15)
fix_variable(x['reboiler_T1_2'],5.15)
fix_variable(x['reboiler_T1_3'],16.85)
fix_variable(x['reboiler_T1_4'],16.85)
fix_variable(x['reboiler_condensate_drum_T1'],16.85)  
fix_variable(x['condensate_pump_T1_1'],16.85)
fix_variable(x['condensate_pump_T1_2'],16.85)

fix_variable(y['stripper_T1'],15.8636)
fix_variable(y['reboiler_T1_1'],7.663599996)
fix_variable(y['reboiler_T1_2'],3.263599996)
fix_variable(y['reboiler_T1_3'],17.2636)
fix_variable(y['reboiler_T1_4'],12.8636)
fix_variable(y['reboiler_condensate_drum_T1'],7.663599996)  
fix_variable(y['condensate_pump_T1_1'],3.247699996)
fix_variable(y['condensate_pump_T1_2'],0.415899996)

fix_variable(x['condenser_T1_1'],15.75)
fix_variable(x['condenser_T1_2'],15.75)
fix_variable(x['overhead_received_T1'],15.75)
fix_variable(x['reflux_pump_T1_1'],22.7059)
fix_variable(x['reflux_pump_T1_2'],25.2177)
fix_variable(x['water_wash_pump_T1'],4.7	)

fix_variable(y['condenser_T1_1'],24.7136)
fix_variable(y['condenser_T1_2'],	30.4136)
fix_variable(y['overhead_received_T1'],37.1386)
fix_variable(y['reflux_pump_T1_1'],37.1386)
fix_variable(y['reflux_pump_T1_2'],37.1386)  
fix_variable(y['water_wash_pump_T1'],35.7036)


fix_variable(x['stripper_T2'],	37.8177)
fix_variable(x['reboiler_T2_1'],29.6177)
fix_variable(x['reboiler_T2_2'],25.2177)
fix_variable(x['reboiler_T2_3'],36.85)
fix_variable(x['reboiler_T2_4'],36.85)
fix_variable(x['reboiler_condensate_drum_T2'],37.25)  
fix_variable(x['condensate_pump_T2_1'],37.25)
fix_variable(x['condensate_pump_T2_2'],37.25)

fix_variable(y['stripper_T2'],5.15)
fix_variable(y['reboiler_T2_1'],5.15)
fix_variable(y['reboiler_T2_2'],5.15)
fix_variable(y['reboiler_T2_3'],13.5659)
fix_variable(y['reboiler_T2_4'],17.9659)
fix_variable(y['reboiler_condensate_drum_T2'],23.1659)  
fix_variable(y['condensate_pump_T2_1'],27.5818)
fix_variable(y['condensate_pump_T2_2'],30.4136)
...
# Set bounds of axis
plt.axis('square')
scalebar = AnchoredSizeBar(ax.transData,10,sep=10,label="bar scale: 10 m",loc ='upper right',bbox_to_anchor=(1,-.2),bbox_transform=ax.transAxes,frameon=False,size_vertical=0.05)
