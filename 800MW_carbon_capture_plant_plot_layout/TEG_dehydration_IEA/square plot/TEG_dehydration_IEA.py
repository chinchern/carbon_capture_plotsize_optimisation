...
units = ['TEG_dehydration_package_T1','TEG_dehydration_package_T2']
Nunits = len(units)

if SwitchSafetyDistances == 1:
    # type of equipment      
   column =['TEG_dehydration_package_T1','TEG_dehydration_package_T2']
...
alpha['TEG_dehydration_package_T1'] = 8
alpha['TEG_dehydration_package_T2'] =8

beta['TEG_dehydration_package_T1'] = 4
beta['TEG_dehydration_package_T2'] = 4
