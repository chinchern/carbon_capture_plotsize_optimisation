...
fix_variable(x['direct_contact_cooler'],96.99999999999999)
fix_variable(x['absorber'],40.999999999999986)
fix_variable(x['lean_amine_cooler'],49.0)
fix_variable(x['cross_heat_exchanger'],26.0)
fix_variable(x['stripper'],102.0)
fix_variable(x['storage_tank'],17.0)
fix_variable(x['reclaimer'],9.0)

fix_variable(y['direct_contact_cooler'],33.0)
fix_variable(y['absorber'],33.0)
fix_variable(y['lean_amine_cooler'],76.12394216826665)
fix_variable(y['cross_heat_exchanger'],64.0)
fix_variable(y['stripper'],99.18697108413333)
fix_variable(y['storage_tank'],89.00000000000034)
fix_variable(y['reclaimer'],63.00000000000034)


fix_variable(x['compressor_house'],39.999999999999986)
fix_variable(x['compressor_KOdrum'],56.99999999999998)
fix_variable(x['compressor_interstage_cooler'],24.99999999999999)
fix_variable(x['TEG_dehydration'],6.999999999999995)

fix_variable(y['compressor_house'],113.25000000000001)
fix_variable(y['compressor_KOdrum'],113.25000000000001)
fix_variable(y['compressor_interstage_cooler'],117.00000000000034)
fix_variable(y['TEG_dehydration'],113.25000000000006)

# direct_contact_cooler,96.99999999999999,33.0,66.0,66.0
# absorber,40.999999999999986,33.0,46.0,46.0
# lean_amine_cooler,49.0,76.12394216826665,30.0,30.0
# cross_heat_exchanger,26.0,64.0,16.0,16.0
# stripper,102.0,99.18697108413333,60.0,60.0
# storage_tank,17.0,89.00000000000034,34.0,34.0
# reclaimer,9.0,63.00000000000034,18.0,18.0
# compressor_house,39.999999999999986,113.25,8.0,37.5
# compressor_KOdrum,56.99999999999998,113.25000000000001,26.0,26.0
# compressor_interstage_cooler,24.99999999999999,117.00000000000034,22.0,22.0
# TEG_dehydration,6.999999999999995,113.25000000000006,14.0,14.0
# --------------Initiate Solve--------------
...
# Set bounds of axis
plt.axis('square')
scalebar = AnchoredSizeBar(ax.transData,25,sep=10,label="bar scale: 25 m",loc ='lower left',bbox_to_anchor=(0.65,0.1),bbox_transform=ax.transAxes,frameon=False,size_vertical=0.05)
