...
# Square Plot Iteration 1
fix_variable(x['flue_gas_fan_T1'],19.3)
fix_variable(x['DCC_T1'],19.3)
fix_variable(x['DCC_pump_T1_1'],19.3)
fix_variable(x['DCC_pump_T1_2'],15.377)
fix_variable(x['DCC_cooler_T1_1'],8)
fix_variable(x['DCC_cooler_T1_2'],2)
fix_variable(x['DCC_cooler_T1_3'],2)

fix_variable(y['flue_gas_fan_T1'],4)
fix_variable(y['DCC_T1'],28)
fix_variable(y['DCC_pump_T1_1'],19.0385)
fix_variable(y['DCC_pump_T1_2'],19.0385)
fix_variable(y['DCC_cooler_T1_1'],19.0385)
fix_variable(y['DCC_cooler_T1_2'],19.0385)
fix_variable(y['DCC_cooler_T1_3'],28)
